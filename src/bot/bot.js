...
import { manageMonitors, manageSubscriptions, manageSettings, getStats } from "./commands/manageMonitors.js"; 
import { WATCHDOG_BOT_TOKEN } from "./config.js"; 

const bot = new TelegramBot(WATCHDOG_BOT_TOKEN, { polling: true });

bot.onText(/\/start/, (msg) => {
  const chatId = msg.chat.id;
  bot.sendMessage(chatId, "Welcome to the Watchdog Bot! Use /help to see available commands.");
});
